    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-6 pt-24">
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4 ">
          Welcome to <span className="font-courgette">FarmerFrend</span>
        </h1>
        ...
        <button
          className="mt-6 px-6 py-3 bg-primary text-white font-semibold rounded-xl hover:bg-secondary transition duration-300"
